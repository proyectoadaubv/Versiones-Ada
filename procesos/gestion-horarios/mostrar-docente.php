...
$query_docente="SELECT tp.ced_persona, tp.nom_persona, tp.ape_persona FROM reg.tbl_persona tp
          ...
          INNER JOIN rec.tbl_tipo_persona ttp ON(tcp.cod_tipop = ttp.cod_tipo_persona) WHERE tp.nom_persona  LIKE '%$desc_buscar%';";
...
$datos_docente= pg_num_rows($resultado_docente);
         ...
         $fila_docente = pg_fetch_array ($resultado_docente,$i);
          ?>
         <tr style='cursor:pointer' onclick="mostrar_docente('<?php echo $fila_docente[0]; ?>',
