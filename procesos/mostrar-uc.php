...
<body>
<table class="tabla_general" id="tabla-mostrar-uc" border="0">
   <thead>
   <th style='width:10%;'>C&oacutedigo</th>
...
$datos_unidadc= pg_num_rows($resultado_unidadc);
         ...
         $fila_unidadc = pg_fetch_array ($resultado_unidadc,$i);
          ?>
         <tr style='cursor:pointer' onclick="uc_id_modificar('<?php echo $fila_unidadc["cod_unidadc"]; ?>',
         '<?php echo $fila_unidadc["desc_unidadc"]; ?>','<?php echo $fila_unidadc["horas_uc"]; ?>',
         '<?php echo $fila_unidadc["inicio"]; ?>','<?php echo $fila_unidadc["fin"]; ?>',
         '<?php echo $fila_unidadc["tipo_uc"]; ?>','<?php echo $fila_unidadc["desc_mod"]; ?>','<?php echo $fila_unidadc["desc_version"]; ?>');">
